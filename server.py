...
parser.add_argument('--ip', type=str, default='172.16.50.32')               # master(执行server.py的ip)
parser.add_argument('--nic_ip', type=str, default='172.16.200.32')          # master(执行server.py的nic_ip)
